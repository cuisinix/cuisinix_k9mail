...
implements OnClickListener, AdapterView.OnItemClickListener, AnimationListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.set_sort).setOnClickListener(this);
		findViewById(R.id.accounts).setOnClickListener(this);
		findViewById(R.id.check_mail).setOnClickListener(this);
		findViewById(R.id.list_folders).setOnClickListener(this);
...
*/
		  ...
		  */
		  ...
		  public View getView(int position, View convertView, ViewGroup parent) {
			  ...
			  if (message != null) {
				  ...
				  holder.from.setPadding(0, 5, 0, 5);
				  holder.subject.setPadding(0, 5, 0, 5);
				  holder.date.setPadding(0, 5, 0, 5);
				  holder.chip.setPadding(0, 5, 0, 5);
				  holder.selected.setPadding(0, 5, 0, 5);
				  holder.flagged.setPadding(0, 5, 0, 5);
			  }
		  ...
		  private void bindView(final int position, final View view, final MessageViewHolder holder,
			  ...
			  if (holder.preview != null) {
				  ...
				  Spannable str = (Spannable)holder.preview.getText();
				  //holder.preview.setPadding(0, 5, 0, 5);
	 ...
	 private void showSortDialog(){
		 final CharSequence[] items = {getString(R.string.sort_by_date),
				 getString(R.string.sort_by_subject),
				 getString(R.string.sort_by_sender),
				 getString(R.string.sort_by_flag),
				 getString(R.string.sort_by_unread),
				 getString(R.string.sort_by_attach)};
		 ...
		 private void showSelectDialog(){
			 final CharSequence[] items = {getString(R.string.batch_select_all),
					 getString(R.string.batch_deselect_all)};

			 AlertDialog.Builder builder = new AlertDialog.Builder(this);
			 builder.setTitle(getString(R.string.batch_select_all));
			 builder.setItems(items, new DialogInterface.OnClickListener() {
				 public void onClick(DialogInterface dialog, int item) {
					 switch (item){
					 case 0:
		 ...
		 private void showBatchOpsDialog(){
			 final CharSequence[] items = {getString(R.string.batch_flag_mode),
					 getString(R.string.batch_delete_op),
					 getString(R.string.batch_mark_read_op),
					 getString(R.string.batch_mark_unread_op),
					 getString(R.string.batch_flag_op),
					 getString(R.string.batch_unflag_op),
					 getString(R.string.batch_archive_op),
					 getString(R.string.batch_spam_op),
					 getString(R.string.batch_move_op),
					 getString(R.string.batch_copy_op)};

			 AlertDialog.Builder builder = new AlertDialog.Builder(this);
			 builder.setTitle(getString(R.string.batch_ops));
			 builder.setItems(items, new DialogInterface.OnClickListener() {
				 public void onClick(DialogInterface dialog, int item) {
					 final List<MessageInfoHolder> selection = getSelectionFromCheckboxes();
					switch(item){
		 ...
		 private void showSettingsDialog(){
			 final CharSequence[] items = {getString(R.string.folder_settings_action),
					 getString(R.string.account_settings_action),
					 getString(R.string.global_settings_action)};
	 
			 AlertDialog.Builder builder = new AlertDialog.Builder(this);
			 builder.setTitle(getString(R.string.preferences_action));
			 builder.setItems(items, new DialogInterface.OnClickListener() {
				 public void onClick(DialogInterface dialog, int item) {
					 switch (item){
					 case 0:
						 if (mFolderName != null) {
							 FolderSettings.actionSettings(MessageList.this, mAccount, mFolderName);
						 }
						 break;
					 case 1:
						 onEditAccount();
		 ...
		 private void showMoreDialog(){
			 final CharSequence[] items = {getString(R.string.batch_select_all),
					 getString(R.string.batch_ops),
					 getString(R.string.send_messages_action),
					 getString(R.string.mark_all_as_read_action),
					 getString(R.string.preferences_action),
					 getString(R.string.expunge_action)};
	 
			 AlertDialog.Builder builder = new AlertDialog.Builder(this);
			 builder.setTitle(getString(R.string.more_action));
			 builder.setItems(items, new DialogInterface.OnClickListener() {
				 public void onClick(DialogInterface dialog, int item) {
					 switch (item){
					 case 0 :
		 ...
		 public void onClick(View v) {
			 ...
			 if(v.getId() == R.id.batch_read_button || v.getId() == R.id.batch_delete_button || v.getId() == R.id.batch_flag_button || v.getId() == R.id.batch_done_button){
				 	 boolean newState = false;
