...
//       setOnClickListener(R.id.reply_all_scrolling);
     ...
     */
    // Désactivé pour éviter les problèmes lors du scroll du menu
    @Override
...
// (Issue 3319)            mController.setFlag(mAccount, mMessageReference.folderName, new String[] { mMessage.getUid() }, Flag.SEEN, false);
    ...
    private void showMoreDialog(){
		 final CharSequence[] items = {getString(R.string.flag_action),
				 ...
				 getString(R.string.select_text_action)};
