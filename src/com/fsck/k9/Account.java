...
public class Account implements BaseAccount {
    ...
    public static final MessageFormat DEFAULT_MESSAGE_FORMAT = MessageFormat.AUTO;
    public static final boolean DEFAULT_MESSAGE_FORMAT_AUTO = true;
    ...
    protected Account(Context context) {
        ...
        AccountSetupComposition.saveSignatureInHtmlFile(context, s.toString());
...
//    }
    ...
    private synchronized void saveIdentities(SharedPreferences prefs, SharedPreferences.Editor editor) {
        ...
        for (Identity identity : identities) {
            ...
            editor.putString(mUuid + ".signature." + ident, identity.getSignature().toString());
